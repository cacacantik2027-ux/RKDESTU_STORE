...
mkdir -p /var/www/html/data/uploads/logo
...
if [ ! -L /var/www/html/assets/img/logo ]; then
  if [ -d /var/www/html/assets/img/logo ]; then
    cp -rn /var/www/html/assets/img/logo/. /var/www/html/data/uploads/logo/ 2>/dev/null || true
    rm -rf /var/www/html/assets/img/logo
  fi
  ln -s /var/www/html/data/uploads/logo /var/www/html/assets/img/logo
fi
